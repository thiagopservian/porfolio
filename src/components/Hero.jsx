            ...
            <div className="hero-content">
                <div className="hero-text">
                    ...
                    <div className="hero-buttons">
                        ...
                        <button className="btn btn-outline" onClick={() => document.getElementById('skills')?.scrollIntoView({ behavior: 'smooth' })}>
                            {t('hero.contact')}
                        </button>
                    </div>
                    <div className="hero-socials">
                        ...
                        <a href="mailto:thiago@example.com" className="social-link" title="Email">
